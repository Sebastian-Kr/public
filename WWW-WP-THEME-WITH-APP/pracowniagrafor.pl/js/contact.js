...
// END Mobile customization
  ...
  map:{
    options:{
    key: 'AIzaSyC8M44NfJKLjTpscMacbK-FX50m_1evk0A',


         center:[50.052394, 19.941050],
         zoom: zm,
         styles: styles,
         scrollwheel: false,
  ...
  marker:{
    values:[
      {latLng:[50.052394, 19.941050], data: 'ul. Stradomska 16/14, Kraków', options:{icon: "https://pracowniagrafor.pl/wp-content/themes/prgrm-theme/img/pointer.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
