...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.028773, 20.253330], data: 'ul. Malwowa 30, 30-611 Kraków', options:{icon: "http://progremo.pl/customers_file/pin-map.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
