...
{block name="other_input"}
	...
	<label for="select_right" class="control-label col-lg-3 required">{l s='Post:' mod='owlblog'}</label>
	<div class="col-lg-9">
		...
		<tr>
			<td>
				<select multiple id="select_left">
					...
					<option value="{$product.id_owl_blog_post|escape:'html':'UTF-8'}">{$product.name|escape:'html':'UTF-8'}</option>
					{/foreach}
				</select>
				<span class="hint" name="help_box">{l s='Double click to move the item to another column' mod='owlblog'}<span class="hint-pointer">&nbsp;</span></span>
				<br /><br />
			...
			<td>
				<select multiple id="select_right" name="posts[]">
					...
					<option selected="selected" value="{$product.id_owl_blog_post|escape:'html':'UTF-8'}">{$product.name|escape:'html':'UTF-8'}</option>
					{/foreach}
				</select>
				<span class="hint" name="help_box">{l s='Double click to move the item to another column' mod='owlblog'}<span class="hint-pointer">&nbsp;</span></span>
				<br /><br />
				<a href="#" id="move_to_left" class="multiple_select_remove btn btn-default">
					&lt;&lt; {l s='Remove' mod='owlblog'}
				</a>
			</td>
		</tr>
	</table>
