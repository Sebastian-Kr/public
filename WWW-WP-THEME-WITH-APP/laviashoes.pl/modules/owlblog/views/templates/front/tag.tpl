		 ...
		 {block name="left_column"}
          ...
          {block name="content_wrapper"}
            <div id="content-wrapper" class="left-column right-column col-sm-8 col-md-9">	
				<h1 class="page-heading">{l s='Search: ' mod='owlblog'}
					<span class="lighter">{$owl_blog_tag->name|escape:'htmlall':'UTF-8'}</span>
					<span class="heading-counter">{$count|intval}{l s=' results have been found.' mod='owlblog'}</span>
				</h1>
				...
				{if $owl_postes_empty == 1}
					<div class="empty">{l s='There are no posts in this tag' mod='owlblog'}</div>
				{/if}
