...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.053864, 19.922233], data: 'ul. Kościuszki 37, Kraków', options:{icon: "http://progremo.pl/customers_file/pin_orange.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
