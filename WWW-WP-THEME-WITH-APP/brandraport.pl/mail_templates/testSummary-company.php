...
<body>
    <div
        style="background-color: #081557; margin: 0 auto; text-align: left; width: 600px; color: #fff; font-size: 15px; line-height: 24px; ">
        <img src="http://progremo.pl/customers_file/brandRaport/mailing-img/header-test-company.png"
        ...
        <img src="http://progremo.pl/customers_file/brandRaport/mailing-img/label-information.png" alt="INFORMACJE" />
        ...
        <table style="margin: 15px auto; color: #fff; font-family: Muli, Tahoma, Geneva, sans-serif; font-weight: 500;"
            ...
            <tr style="color:#17E9A7" class="greenText">
                ...
                <td style="text-align:right" width="50%"><?php echo $mail ;?></td>
            </tr>
            <tr>
                <td width="50%">Data:</td>
                <td style="text-align:right" width="50%">15.01.2019, 15:44</td>
            </tr>
        </table>

        <img src="http://progremo.pl/customers_file/brandRaport/mailing-img/label-summary-test.png"
            alt="WYNIKI TESTU" />

        <table style="margin: 0 auto; color: #fff; font-family: Muli, Tahoma, Geneva, sans-serif; font-weight: 500;"
        ...
        <div style="text-align: center;">
            <img style="margin: 50px auto;"
                src="http://progremo.pl/customers_file/brandRaport/mailing-img/logo-footer.png"
