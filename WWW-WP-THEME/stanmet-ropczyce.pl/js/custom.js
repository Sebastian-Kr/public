...
// Items after download more
  ...
  var lightboxContent = document.querySelector('#lighboxContent');
...
// alert('test9');
	...
	// Open lighbox function
		function openLighbox(i, url2, content){
...
function prevLightbox() {
  activeLlightbox--;
	...
	content=FotoList[activeLlightbox].content;
...
// add image functions
    ...
    // console.log(position);
		...
		gallery_item.setAttribute('content', content );

    gallery_item_content = document.createElement("div");
    gallery_item_content.innerHTML = content;
		gallery_item.appendChild(gallery_item_content);


    FotosContainer.appendChild(gallery_item);
// console.log(url2);
openLighbox(i, url2, content)
	};
...
var moveForce = 77; // max popup movement in pixels
var rotateForce = 44; // max popup rotation in deg
...
$(document).mousemove(function(e) {
    ...
    $('.popup2')
        // .css('left', moveX+'px')
        // .css('top', moveY+'px');
        .css('transform', 'rotateX('+rotateX/4+'deg) rotateY('+rotateY/4+'deg)');
});
