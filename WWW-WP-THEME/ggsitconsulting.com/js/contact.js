...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.0648305,19.9675295], data: 'ul. Cystersów 13A/3', options:{icon: "http://ggsitconsulting.com/wp-content/themes/prgrm-theme/img/pointer.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
