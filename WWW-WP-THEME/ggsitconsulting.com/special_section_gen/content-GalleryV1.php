...
<section id="<?php echo $id ?>" class="<?php echo $css_theme; echo ' '; echo $css_custom ?>">
  ...
  <?php if (get_sub_field('theme')=='gallery-netlightbox'): ?>
      <div id="gallery" class="container">
        <div id="image-gallery">
          <div class="row">
              ...
              $ar = wp_get_attachment_image_src($img_id, 'small');
              $ar2 = wp_get_attachment_image_src($img_id, 'full');
               ?>

 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 image">
   <div class="img-wrapper">
     <a href="<?php echo $ar2[0]; ?>">
       <img src="<?php echo $ar2[0]; ?>" alt="">
       <div class="img-box" style="background-image: url('<?php echo $ar[0]; ?>')"></div>
     </a>
...
<?php if (get_sub_field('theme')=='gallery-titlebox'): ?>
