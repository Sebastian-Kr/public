...
function progremo_setup() {
  ...
  add_image_size( 'gallery-min', 590 );
...
function progremo_styles() {
	...
	// wp_enqueue_style ( 'project_style', get_template_directory_uri() . '/style_project.min.css');
wp_enqueue_script( 'custom', get_template_directory_uri() . '/js/custom.js', array(), '', true );
wp_enqueue_script( 'fancybox', get_template_directory_uri() . '/js/fancybox.js', array(), '', true );
