...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.072086, 19.920447], data: 'ul. Królewska 39/1, 30-045 Kraków', options:{icon: "http://progremo.pl/customers_file/pin12.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
