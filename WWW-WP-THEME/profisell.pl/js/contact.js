...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.278788, 19.557007], data: 'Ul.Mickiewicza 7 Olkusz', options:{icon: "http://profisell.pl/wp-content/themes/prgrm-theme/img/pointer.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
