...
<?php get_template_part( 'content', 'breadcrumb' );?>
       ...
       <section class="bg1 kdouble">
            <div class="container-fluid section-item">
            <div class="row">

<?php if (!(get_field('k1_hide'))): ?>
  <div class="col-md-6 ">
