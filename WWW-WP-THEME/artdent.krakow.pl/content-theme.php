...
<?php if (get_field($col)==1): ?>
  ...
  <div class="col-sm-12 <?php the_field($prgrm_col_class1)?>">
    ...
    <?php if (get_field($img_position) == 'up'){echo '<img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content1), true), 6 ) . '"  src="'; echo the_field($prgrm_img1).'">';}
    echo the_field($prgrm_content1) ;
      if ((get_field($img_position)) == 'down'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content1), true), 6 ) . '" src="'; echo the_field($prgrm_img1).'">';}
    ?>
</div>
  </div>
...
<?php if (get_field($col)==2): ?>
  ...
  <?php
      if ((get_field($img_position) == 'up') and ((get_field($prgrm_img1)))){echo '<img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content1), true), 6 ) . '" src="'; echo the_field($prgrm_img1).'">';}
      ...
      if ((get_field($img_position) == 'anime-border') and ((get_field($prgrm_img1)))){  echo '<div class="rotate"><img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content1), true), 6 ) . '" src="'.get_field($prgrm_img1).'"><div class="border-turned"></div></div>';}
      echo the_field($prgrm_content1);
      if ((get_field($img_position)) == 'down'){echo '<img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content1), true), 6 ) . '" src="'; echo the_field($prgrm_img1).'">';}
    ?>
  </div>
  ...
  <div class="col-sm-6 <?php the_field($prgrm_col_class2)?>"<?php if ((get_field($img_position) == 'full-background') and ((get_field($prgrm_img2)))) { echo 'style="background-image: url(\''.get_field($prgrm_img2).'\')"';} ?>>
    <?php
    if ((get_field($img_position) == 'up') and ((get_field($prgrm_img2)))){echo '<img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content2), true), 6 ) . '" src="'; echo the_field($prgrm_img2).'">';}
    ...
    if ((get_field($img_position) == 'anime-border') and ((get_field($prgrm_img2)))){ echo '<div class="rotate"><img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content2), true), 6 ) . '" src="'.get_field($prgrm_img2).'"><div class="border-turned"></div></div>';}
    echo the_field($prgrm_content2);
    if ((get_field($img_position)) == 'down'){echo '<img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content2), true), 6 ) . '" src="'; echo the_field($prgrm_img2).'">';}
    ?>
  </div>
...
<?php if (get_field($col)==3): ?>
  ...
  <div class="col-sm-4 <?php the_field($prgrm_col_class2)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content2), true), 6 ) . '" src="'; echo the_field($prgrm_img2).'">';}
  ...
  <div class="col-sm-4 <?php the_field($prgrm_col_class3)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content3), true), 6 ) . '" src="'; echo the_field($prgrm_img3).'">';}
    ...
    echo the_field($prgrm_content3);
          if ((get_field($img_position)) == 'down'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content3), true), 6 ) . '" src="'; echo the_field($prgrm_img3).'">';}
          ?>
  </div>
...
<?php if (get_field($col)==4): ?>
  ...
  <div class="col-sm-3 <?php the_field($prgrm_col_class4)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content4), true), 6 ) . '" src="'; echo the_field($prgrm_img4).'">';}
    echo the_field($prgrm_content4);
          if ((get_field($img_position)) == 'down'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content4), true), 6 ) . '" src="'; echo the_field($prgrm_img4).'">';}
          ?>
  </div>
...
<?php if (get_field($col)==5): ?>
  ...
  <div class="col-sm-2 <?php the_field($prgrm_col_class5)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content5), true), 6 ) . '" src="'; echo the_field($prgrm_img5).'">';}
    echo the_field($prgrm_content5);
          if ((get_field($img_position)) == 'down'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content5), true), 6 ) . '" src="'; echo the_field($prgrm_img5).'">';}
          ?>
  </div>
  <div class="col-sm-1"></div>
...
<?php if (get_field($gridcol)=='2w3k') echo '</div><div class="row">' ?>
  ...
  <div class="<?php echo $colclass ?> <?php the_field($prgrm_col_class6)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content6), true), 6 ) . '" src="'; echo the_field($prgrm_img6).'">';}
    echo the_field($prgrm_content6);
          if ((get_field($img_position)) == 'down'){echo '<img alt="' . wp_trim_words( wp_strip_all_tags(get_field($prgrm_content6), true), 6 ) . '"  src="'; echo the_field($prgrm_img6).'">';}
          ?>
  </div>
