<h4>Przerwa serwisowa</h4>
<?php

echo 'prace serwisowe';
for ($i=1; $i < 12 ; $i++) {
...
<?php if (get_field($col)==2): ?>
  ...
  <?php if ((get_field($img_position) == 'full-background') and (!empty(get_field($prgrm_img1)))) { echo 'style="background-image: url(\''.get_field($prgrm_img1).'\')"';} ?>>
  <?php
      if ((get_field($img_position) == 'up') and (!empty(get_field($prgrm_img1)))){echo '<img alt=" " src="'; echo the_field($prgrm_img1).'">';}
      if ((get_field($img_position) == 'up-zoom') and (!empty(get_field($prgrm_img1)))){ echo '<div class="zoombox"><div style="background-image: url(\''.get_field($prgrm_img1).'\')"></div></div>';}
      if ((get_field($img_position) == 'anime-border') and (!empty(get_field($prgrm_img1)))){  echo '<div class="rotate"><img alt=" " src="'.get_field($prgrm_img1).'"><div class="border-turned"></div></div>';}
      echo the_field($prgrm_content1);
      if ((get_field($img_position)) == 'down'){echo '<img alt=" " src="'; echo the_field($prgrm_img1).'">';}
    ?>
  </div>

  <div class="col-sm-6 <?php the_field($prgrm_col_class2)?>"<?php if ((get_field($img_position) == 'full-background') and (!empty(get_field($prgrm_img2)))) { echo 'style="background-image: url(\''.get_field($prgrm_img2).'\')"';} ?>>
    <?php
    if ((get_field($img_position) == 'up') and (!empty(get_field($prgrm_img2)))){echo '<img alt=" " src="'; echo the_field($prgrm_img2).'">';}
    if ((get_field($img_position) == 'up-zoom') and (!empty(get_field($prgrm_img2)))){ echo '<div class="zoombox"><div style="background-image: url(\''.get_field($prgrm_img2).'\')"></div></div>';}
    if ((get_field($img_position) == 'anime-border') and (!empty(get_field($prgrm_img2)))){ echo '<div class="rotate"><img alt=" " src="'.get_field($prgrm_img2).'"><div class="border-turned"></div></div>';}
...
<?php if (get_field($col)==3): ?>
  <div class="col-sm-4 <?php the_field($prgrm_col_class1)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt=" " src="'; echo the_field($prgrm_img1).'">';}
      if ((get_field($img_position) == 'up-zoom') and (!empty(get_field($prgrm_img1)))){ echo '<div class="zoombox  zoombox-x3"><div style="background-image: url(\''.get_field($prgrm_img1).'\')"></div></div>';}
    echo the_field($prgrm_content1) ;
          if ((get_field($img_position)) == 'down'){echo '<img  alt=" " src="'; echo the_field($prgrm_img1).'">';}
          ?>
  </div>
  ...
  <div class="col-sm-4 <?php the_field($prgrm_col_class2)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt=" " src="'; echo the_field($prgrm_img2).'">';}
      if ((get_field($img_position) == 'up-zoom') and (!empty(get_field($prgrm_img2)))){ echo '<div class="zoombox zoombox-x3"><div style="background-image: url(\''.get_field($prgrm_img2).'\')"></div></div>';}
    echo the_field($prgrm_content2) ;
          if ((get_field($img_position)) == 'down'){echo '<img  alt=" " src="'; echo the_field($prgrm_img2).'">';}
          ?>
  </div>
  ...
  <div class="col-sm-4 <?php the_field($prgrm_col_class3)?>">
    <?php if (get_field($img_position) == 'up'){echo '<img  alt=" " src="'; echo the_field($prgrm_img3).'">';}
      if ((get_field($img_position) == 'up-zoom') and (!empty(get_field($prgrm_img3)))){ echo '<div class="zoombox zoombox-x3"><div style="background-image: url(\''.get_field($prgrm_img3).'\')"></div></div>';}
