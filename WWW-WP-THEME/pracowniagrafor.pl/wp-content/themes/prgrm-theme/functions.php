...
if (is_page(26)) {
	...
	wp_enqueue_script( 'google', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyC8M44NfJKLjTpscMacbK-FX50m_1evk0A', array(), '', true );
}
				...
				foreach ( $post_types as $post_type ) {
						if( !in_array($post_type->name,$ignoreposttypes)){
								...
								$args = array(
										...
										// 'category__not_in' = 4,
										'post__not_in' => array(559, 252, 247, 630, 132, 52,694, 693),
