...
// END Mobile customization
  ...
  map:{
    options:{
    key: 'AIzaSyCltLnaVxEl1oU03dSPKZftm3Q-26Oepks',


         center:[49.935012, 19.965338],
         zoom: zm,
         styles: styles,
         scrollwheel: false,
  ...
  marker:{
    values:[
      ...
      {latLng:[49.935012, 19.965338], data: 'Franciszka Bielowicza 57/3 32-040 Świątniki Górne', options:{icon: "http://www.notariuszswiatniki.pl/wp-content/themes/prgrm-theme/img/pointer2.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
