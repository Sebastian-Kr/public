...
// END Mobile customization
  ...
  map:{
    options:{
    key: 'AIzaSyCo20Q6d9FkzT5wJWEFaZr2wkELLpsD3Zw',


         center:[50.278788, 19.557007],
         zoom: zm,
         styles: styles,
         scrollwheel: false,
  ...
  marker:{
    values:[
      {latLng:[50.278788, 19.557007], data: 'Ul.Mickiewicza 7 Olkusz', options:{icon: "http://profisell.progremo.pl/wp-content/themes/prgrm-theme/img/pointer.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
