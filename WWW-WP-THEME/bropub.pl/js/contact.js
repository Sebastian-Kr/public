...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.053379, 19.939700], data: 'ul. Stradomska 11 31-058 Kraków', options:{icon: "http://bropub.pl/wp-content/themes/prgrm-theme/img/pointer.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
