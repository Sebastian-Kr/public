...
<div class="interactiveItem" id="home"></div>
     <div id="main-slider" class="carousel slide interactiveItem" data-ride="carousel" data-pause="false">
...
<div id="carousel-main-progremo" >
  ...
  <div class="comon_content">
          ...
          <img class="img1" src="<?php echo get_template_directory_uri()?>/img/logo-duze.png" alt="">
          <img class="img2" src="<?php echo get_template_directory_uri()?>/img/chodobro.svg" alt="">
    ...
    <a href="#menu_piwo">  <button type="button" name="button">PIWA NA KRANACH</button></a>
