...
// END Mobile customization
  ...
  map:{
    options:{
    key: 'AIzaSyApYwVSFQb0pras29IRbiNKkB9a_ZaHu58',
         center:[50.060939, 21.670279],
         zoom: zm,
         styles: styles,
         scrollwheel: false,
  ...
  marker:{
    values:[
      {latLng:[50.054493, 21.608323], data: 'BIURO: ul. Parkowa 1/4 Ropczyce', options:{icon: "http://pit-net.pl/wp-content/themes/prgrm-theme/img/mapicon.png", animation: google.maps.Animation.BOUNCE}},
      {latLng:[50.058759, 21.736005], data: 'SIEDZIBA FIFRMY: Sielec 10a Sędziszów Młp', options:{icon: "http://pit-net.pl/wp-content/themes/prgrm-theme/img/mapicon.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
