...
// window.onload = function() {
  ...
  var lazyBackgroundDivs = document.querySelectorAll('.lazy_loader');

    for (var i = 0; i < lazyBackgroundDivs.length; i++) {

    image = lazyBackgroundDivs[i];


    if (screen.width < 568) {
      // console.log('MOBILE <568px');
      var imageSrc = image.getAttribute("data-smsrc");
      var imageSrc = image.getAttribute("data-smsrc");
    } else if (screen.width < 769) {
      // console.log('MOBILE < 769px');
      var imageSrc = image.getAttribute("data-mdsrc");
    } else if (screen.width < 1025) {
      // console.log('MOBILE <99px');
      var imageSrc = image.getAttribute("data-lgsrc");
    } else if (screen.width < 1550) {
      // console.log('DESKTOP <1550px');
      var imageSrc = image.getAttribute("data-xlsrc");
    } else {
      // console.log('DESKTOP HD');
      var imageSrc = image.getAttribute("data-xxxlsrc");
    }
    ...
    if (image.hasAttribute("src")) {
      ...
      cssValue = 'background-image: url("' + imageSrc + '")';
      image.setAttribute("style", cssValue);
      image.classList.add("lazy_loaded");
    }
  ...
  var lazyGalleryDivs = document.querySelectorAll('.lazy_loader_gallery');

  for (var i = 0; i < lazyGalleryDivs.length; i++) {
  image = lazyGalleryDivs[i];
...
$(document).ready(function() {
  $('#nav-icon2').click(function() {
    ...
    $('#navbarNav').toggleClass('open-menu')
  });
...
var tracker = document.getElementById('header_button');
// console.log(tracker);
var target = document.getElementById('anchor_subheader');
// console.log(target);
if (target != null) {
...
var
  ...
  nav_height = 80,
  // sections = $('section'),
  // section2_menu = $('#section2_link a'),
  // section3_menu = $('#section3_link a'),
  // section1_menu = $('#section1_link a'),
  menu_container = $('#navigation-container'),
...
$(window).on('scroll', function() {
  ...
  if (cur_pos < 200) {
    menu_container.addClass('start_menu', 900);
  }

  if (cur_pos > 200) {
    menu_container.removeClass('start_menu', 900);
  }
  ...
  menu_anchor.each(function() {
    ...
    if (cur_pos >= top && cur_pos <= bottom) {
      ...
      // sections.removeClass('activeItem');
      // $(this).addClass('activeItem');
      nav.find('a[href="#' + $(this).attr('id') + '"]').addClass('activeItem');
    }
  });
...
var footer_nav = $('footer');
// console.log(footer_nav);
footer_nav.find('a').on('click', function() {
  var $el = $(this),
    id = $el.attr('href');
  // console.log(id);
  // console.log($el);
...
$('.wpcf7-form').on('click', function() {
  // console.log('pokaz recaptche');
  $('.grecaptcha-badge').addClass('visable');
});
...
caroGallery_items.each(function(index) {
  var imageFull_url = $(this).attr('data-xlsrc');
...
var pinURL = window.location.href + '/wp-content/themes/prgrm-theme/img/pin.svg';
  ...
  marker:{
    values:[
      {latLng:[50.055152, 19.933461], data: 'ul. Powiśle 12/5, 31-101 Kraków', options:{icon: pinURL, animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
