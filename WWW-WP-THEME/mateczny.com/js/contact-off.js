...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.055152, 19.933461], data: 'ul. Powiśle 12/5, 31-101 Kraków', options:{icon: "http://progremo.pl/customers_file/pin-map.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
