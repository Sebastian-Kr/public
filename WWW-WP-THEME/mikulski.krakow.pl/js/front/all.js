// <!-- <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/cookies.js" type="text/javascript"></script> -->
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/modernizr-2.8.3-respond-1.4.2.min.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/jquery-1.11.2.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/bootstrap.min.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/mobile-menu.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/index.js" type="text/javascript"></script>
...
// <!-- <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/global.js" type="text/javascript"></script> -->
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/jquery.popupoverlay.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/lightslider.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/slider/jquery.bxslider.min.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/swiper/swiper.min.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/map/jquery.cssmap.min.js" type="text/javascript"></script>
...
// <script src="<?php echo get_home_url() ?>/wp-content/themes/progremo_theme/js/front/unslider.js" type="text/javascript"></script>
...
// CUSTOM SCRIPT PROJECT //////////////////////////////////////////////////////////////
              ...
              var sLang = "pl";
              var sSpecialize1 = "specjalizacje";
              var sSpecialize2 = "all";
              var sCat1 = "Specjalizacje";
              var sCat2 = "Wszystkie wpisy";
              var sCat3 = "Prowadzone sprawy";
              var sCat4 = "Media";
              var sCat5 = "Publikacje";
//  second script //////////
...
//////////////////////////////////////////////////////////////////////////
$(document).ready(function() {
var item = localStorage.getItem('overlay');
if(item != 1) {
$('#start').css('display','block');
};

$(".carrer-more").click(function() {

$('#windowind_carrer').popup('show');
});
