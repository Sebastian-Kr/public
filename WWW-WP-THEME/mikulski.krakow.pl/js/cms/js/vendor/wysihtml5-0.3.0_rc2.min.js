...
//(function(b){var c=/wysiwyg-text-align-[a-z]+/g;b.commands.justifyCenter={exec:function(a){return b.commands.formatInline.exec(a,"formatInline","p","wysiwyg-text-align-center",c)},state:function(a){return b.commands.formatInline.state(a,"formatInline","p","wysiwyg-text-align-center",c)},value:function(){}}})(wysihtml5);
//(function(b){var c=/wysiwyg-text-align-[a-z]+/g;b.commands.justifyLeft={exec:function(a){return b.commands.formatInline.exec(a,"formatInline","p","wysiwyg-text-align-left",c)},state:function(a){return b.commands.formatInline.state(a,"formatInline","p","wysiwyg-text-align-left",c)},value:function(){}}})(wysihtml5);
//(function(b){var c=/wysiwyg-text-align-[a-z]+/g;b.commands.justifyRight={exec:function(a){return b.commands.formatInline.exec(a,"formatInline","p","wysiwyg-text-align-right",c)},state:function(a){return b.commands.formatInline.state(a,"formatInline","p","wysiwyg-text-align-right",c)},value:function(){}}})(wysihtml5);
//(function(b){var c=/wysiwyg-text-align-[a-z]+/g;b.commands.justifyJustify={exec:function(a){return b.commands.formatInline.exec(a,"formatInline","p","wysiwyg-text-align-justify",c)},state:function(a){return b.commands.formatInline.state(a,"formatInline","p","wysiwyg-text-align-justify",c)},value:function(){}}})(wysihtml5);
...
(function(b){var c=/wysiwyg-text-align-[a-z]+/g;b.commands.justifyJustify={exec:function(a){return b.commands.formatBlock.exec(a,"formatBlock",null,"wysiwyg-text-align-justify",c)},state:function(a){return b.commands.formatBlock.state(a,"formatBlock",null,"wysiwyg-text-align-justify",c)},value:function(){}}})(wysihtml5);
