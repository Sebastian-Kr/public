	...
	Multiselect.prototype = {
		...
		createOptionValue: function(element) {
			...
			if (inputType == 'checkbox') {
				var $li = $('<li><a href="javascript:void(0);" style="padding: 9px 5px 1px 5px;"><input id="'+id + inputType + value + '" class="css-checkbox" name="'+id+'" type="' + inputType + '" /><label for="'+id + inputType + value + '" class="css-label"></label></a></li>');
			}

			if (inputType == 'radio') {
				var $li = $('<li><a href="javascript:void(0);" style="padding: 9px 5px 1px 5px;"><input id="'+id + inputType + value + '" class="css-radio" name="'+id+'" type="' + inputType + '" /><label for="'+id + inputType + value + '" class="css-label radio"></label></a></li>');
			}
