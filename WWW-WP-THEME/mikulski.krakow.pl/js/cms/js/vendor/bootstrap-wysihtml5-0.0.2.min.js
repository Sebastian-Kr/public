...
//                    "<a class='btn" + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='icon-indent-left'></i></a>" +
        ...
        "justify" : function(locale,options) {
            ...
            return "<li>" +
        		   ...
        		   "<a class='btn" + size + "' data-wysihtml5-command='justifyJustify' title='"+locale.justify.justify+"'><i class='icon-align-justify'></i></a>" +
        		   "</div>" +
        		   "</li>";
          }
    };
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["/css/cms/css/wysiwyg-color.css", "/css/cms/css/bootstrap-wysihtml5-justify.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "pl"
    };
