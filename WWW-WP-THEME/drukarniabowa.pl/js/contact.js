...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[49.970302, 20.607434], data: 'Ul. Czarnowiejska 1, Brzesko', options:{icon: "http://bowa.progremo.pl/wp-content/themes/prgrm-theme/img/pin_mapy.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
