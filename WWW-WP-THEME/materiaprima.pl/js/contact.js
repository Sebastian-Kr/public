...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.063247, 19.926368], data: 'ul. Skarbowa 2, 43-300 Kraków', options:{icon: "https://progremo.pl/customers_file/groteska_pin.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
