...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.028773, 20.253330], data: 'ul. Droga Królewska 77 32-005 Niepołomice', options:{icon: "http://progremo.pl/customers_file/mappin.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
