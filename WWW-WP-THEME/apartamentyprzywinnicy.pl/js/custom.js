...
var animateHTML = function () {
  ...
  var _checkPosition = function () {
    for (var i = 0; i < elems.length; i++) {
      ...
      if (posFromTop - windowHeight <= -offsetHeight) {
        elems[i].className = elems[i].className.replace('animate', 'animation-target')
      }
    }
  }
  return {
...
function slider(slider_id, fotos_php_array) {
	var slider = document.querySelector('.'+slider_id+'.imgbox_slider');
	if (slider !== null) {
...
slider('slider_id1', fotos_php_array1);
slider('slider_id2', fotos_php_array2);
slider('slider_id3', fotos_php_array3);
slider('slider_id4', fotos_php_array4);
