...
function progremo_styles() {
	...
	// wp_enqueue_style ( 'dragdealer', get_template_directory_uri() . '/dragdealer.css');
	// wp_enqueue_script( 'dragdealer', get_template_directory_uri() . '/js/dragdealer.js', array(), '', true );
