...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.009531, 22.071463], data: 'Jana Wąsacza 19, 35-330 Rzeszów', options:{icon: "http://progremo.pl/pointer.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
