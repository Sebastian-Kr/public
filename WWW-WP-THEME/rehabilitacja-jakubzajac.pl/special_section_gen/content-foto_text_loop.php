...
elseif (get_sub_field('foto_text_item_width')==='25%') {
  $class = 'col-md-3 col-sm-6';
    ...
    ?>
<?php if ((get_sub_field('foto_text_item_type'))=='text'): ?>
  <div class=" <?php echo $class.' '; the_sub_field('foto_text_item_css') ?>">
  <div class="foto_text_item_content">
    <?php the_sub_field('foto_text_item_text') ?>
  </div>
  </div>
<?php endif; ?>
<?php if ((get_sub_field('foto_text_item_type'))=='foto'): ?>
  <div class=" <?php echo $class.' '; the_sub_field('foto_text_item_css') ?>">
  <div class="shadow foto_text_item_content" style="background-image: url('<?php the_sub_field('foto_text_item_foto') ?>')">
  </div>
  </div>
<?php endif; ?>
