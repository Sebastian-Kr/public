...
<nav class=" navbar navbar-expand-lg navbar-light ">
  ...
  <li><a class="dynamicItem <?php if (is_page(98)) echo 'activeItem';?>" href="<?php echo get_permalink(98) ?>">Oferta</a></li>
  <li><a class="dynamicItem <?php if (is_page(104)) echo 'activeItem';?>" href="<?php echo get_permalink(104) ?>">Kontakt</a></li>
  </ul>

  </div>
  <a target="blank" class="fb_menu_link" href="<?php the_field('facebook_link',  5)?>"><img src="<?php echo get_template_directory_uri() ?>/img/fb.svg" alt=""></a>
