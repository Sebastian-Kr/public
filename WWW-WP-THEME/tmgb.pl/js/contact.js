...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[49.912855, 20.093997], data: 'ul. Dziekanowice 15, 32-410 Dobczyce', options:{icon: "http://progremo.pl/customers_file/mappin.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
