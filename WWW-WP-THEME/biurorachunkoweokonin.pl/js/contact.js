...
// END Mobile customization
  ...
  marker:{
    values:[
      {latLng:[50.030074, 21.557653], data: 'Okonin 19a, 39-100 Ropczyce', options:{icon: "http://progremo.pl/pointer.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
