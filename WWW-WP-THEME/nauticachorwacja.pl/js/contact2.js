...
// END Mobile customization
  ...
  map:{
    options:{
    key: 'AIzaSyAR5qax5ix9fncK6i7aWMfr3Baef0J4SQU',


         center:[43.502714, 16.442070],
         zoom: zm,
         styles: styles,
         scrollwheel: false,
  ...
  marker:{
    values:[
      {latLng:[43.502714, 16.442070], data: 'Przystań promowa Split', options:{icon: "http://nauticachorwacja.pl/wp-content/themes/prgrm-theme/img/pointer.svg", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
