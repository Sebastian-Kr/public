...
// 	wp_enqueue_script( 'google', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAR5qax5ix9fncK6i7aWMfr3Baef0J4SQU', array(), '', true );
// }
//
//
// if (is_page('3058')) {
// 	wp_enqueue_script( 'contact', get_template_directory_uri() . '/js/contact2.js', array(), '', true );
// 	wp_enqueue_script( 'google', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAR5qax5ix9fncK6i7aWMfr3Baef0J4SQU', array(), '', true );
// }
